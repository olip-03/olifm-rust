...
#[allow(dead_code)]
pub static CI_PLATFORM: Option<&str> = Some("GitHub Actions");
...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/runner/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/runner/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
#[doc=r#"Value of OPT_LEVEL for the profile used during compilation."#]
#[allow(dead_code)]
pub static OPT_LEVEL: &str = "s";
...
#[doc=r#"The output of `/home/runner/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.89.0 (29483883e 2025-08-04)";
#[doc=r#"The output of `/home/runner/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/runner/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
